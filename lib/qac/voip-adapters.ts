...
export const DEFAULT_MAPPINGS: Record<string, string[]> = {
  recording_url: [
    ...
    "recordingUrl", "file_url", "mp3_url", "wav_url",
  ],
  agent_name: [
    "agent_name", "To", "user_name", "extension",
    "sip_user", "called_number", "callee", "agent", "dst",
  ],
  customer_phone: [
    "From", "caller_id", "customer_phone", "ani",
    "calling_number", "callerNumber", "src", "clid",
  ],
  call_id: [
    "CallSid", "call_id", "callId", "session_id",
    "external_call_id", "call_uuid", "uniqueid", "id",
  ],
  duration: [
    "RecordingDuration", "duration", "call_duration",
    "callDuration", "duration_seconds", "length", "billsec",
  ],
  transcript: ["transcript", "transcription", "text", "call_transcript", "body"],
  agent_id: [
    "agent_id", "user_id", "extension_id",
    "sip_user_id", "agent_ext", "operator_id",
  ],
  direction: ["direction", "call_direction", "callDirection", "call_type", "type"],
  outcome: [
    "outcome", "call_outcome", "disposition",
    "hangup_cause", "status", "lastapp",
  ],
  language: ["language", "lang", "transcript_lang", "locale"],
  customer_name: [
    "customer_name", "contact_name", "callerName",
