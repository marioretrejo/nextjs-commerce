    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="bg-white px-6 pb-32 pt-24 sm:px-12 lg:pt-36 lg:pb-40">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-4 text-xs text-[#888]">Free plan includes 50 minutes/month.</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-wrap items-center gap-x-10 gap-y-3">
            {SOCIAL_PROOF_LOGOS.map((name) => (
              <span key={name} className="text-xs font-medium text-[#bbb] tracking-wide select-none">
                {name}
              </span>
            ))}
          </div>
      ...
      <section className="border-t border-black/8 bg-white px-6 py-28 sm:px-12" id="pricing">
        <div className="mx-auto max-w-5xl">
            ...
            {[
              ...
              >
                ...
                <div className="mt-3 flex items-end gap-1">
                  <span className="text-4xl font-light" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
                    {plan.price}
                  </span>
                  {plan.price !== '$0' && (
          ...
          <p className="mt-5 text-xs text-[#888]">Start free. Scale when you&apos;re ready. Cancel anytime.</p>
        </div>
      </section>
