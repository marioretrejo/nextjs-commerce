...
export default function AgentAssistPage() {
  ...
  const [complianceRisk, setRisk] = useState<
            ...
            <CardHeader className="pb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {active && countdown > 0 && !analyzing && (
                    <div className="flex items-center gap-1.5 text-[10px] text-[#9b9b9b]">
                      ...
                      <span>
                        analyzing in{" "}
                        {Math.ceil((countdown * DEBOUNCE_MS) / 1000)}s
                      </span>
                    </div>
                  )}
              ...
              {active && (
                <p className="text-[11px] text-[#9b9b9b] mt-0.5">
                  Auto-analyzing every {DEBOUNCE_MS / 1000}s after you stop
                  typing.
                </p>
              )}
            </CardHeader>
          ...
          {!active && alerts.length === 0 && (
            <Card className="border-dashed border-[#e0e0e0]">
              <CardContent className="py-6 text-center space-y-3">
                ...
                <Button size="sm" onClick={toggleActive} className="gap-1.5">
                  <Zap className="h-3.5 w-3.5" />
                  Enable Active Mode
                </Button>
              </CardContent>
