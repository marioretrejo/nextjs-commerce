    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure how the widget looks on your website.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setConfig((c) => ({ ...c, button_text: e.target.value }))
                  }
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setConfig((c) => ({ ...c, button_color: e.target.value }))
                    }
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add one of these snippets to your website's HTML.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
          ...
          <p className="text-xs text-[#6b6b6b]">
            The widget requires microphone access. Ensure your website is served
            over HTTPS.
          </p>
        </CardContent>
      </Card>
