...
export default function QualityPage() {
  ...
  const [editingCriteria, setEditingCriteria] = useState<QACriteria | null>(
    null,
  );
    ...
    <div className="p-6 max-w-7xl mx-auto">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => openAddCriteria(agent.id)}
                    >
      ...
      <Dialog open={criteriaDialogOpen} onOpenChange={setCriteriaDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editingCriteria ? "Edit Criteria" : "Add QA Criteria"}
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setCriteriaForm((f) => ({ ...f, name: e.target.value }))
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={([v]) =>
                  setCriteriaForm((f) => ({ ...f, weight: v ?? f.weight }))
                }
              />
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={savingCriteria || !criteriaForm.name.trim()}
            >
              {savingCriteria
                ? "Saving…"
                : editingCriteria
