    ...
    <div className="p-6 mx-auto max-w-3xl space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label>Name</Label>
              <Input
                placeholder="Product FAQ, Pricing Sheet…"
                value={form.name}
                onChange={(e) =>
          ...
          {form.type === "text" && (
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, content_text: e.target.value }))
                }
              />
            </div>
          )}
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-[#e0e0e0] py-16 text-center">
          ...
          <p className="text-sm text-[#6b6b6b]">
            Add documents so your agent can answer questions from your content.
          </p>
        </div>
      ) : (
              ...
              <CardContent className="flex items-center justify-between p-4">
                ...
                <div className="flex items-center gap-2">
                  {doc.status === "processing" && (
                    <Loader2 className="h-3 w-3 animate-spin text-[#6b6b6b]" />
                  )}
                  <Badge
