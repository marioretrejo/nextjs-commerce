    ...
    <div className="min-h-screen bg-[#f5f5f5]">
      <div className="bg-white border-b border-[#e0e0e0] px-6 py-4 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-[#6b6b6b]">
            Superadmin only — provider configuration and cost visibility
          </p>
        </div>
      </div>
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        {tab === "health" && (
          <div className="space-y-4">
            <p className="text-sm text-[#6b6b6b]">
              Real-time provider status. Configure automatic failover rules
              below.
            </p>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-8 text-sm">
                        <div className="text-center">
                          ...
                          <p
                            className={`font-medium ${p.latency > 300 ? "text-yellow-600" : "text-[#0a0a0a]"}`}
                          >
                            {p.latency} ms
                          </p>
                        </div>
                        <div className="text-center">
                          ...
                          <p
                            className={`font-medium ${p.errorRate > 1 ? "text-red-600" : "text-[#0a0a0a]"}`}
                          >
                            {p.errorRate}%
                          </p>
                        </div>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Automatic routing when a provider degrades or goes down.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
                  {[
                    {
                      trigger: "ElevenLabs error rate > 5%",
                      action: "Switch Standard Voice → Cartesia Sonic-3",
                    },
                    {
                      trigger: "Cartesia latency > 500ms",
                      action: "Switch Ultra-Fast → Deepgram STT bridge",
                    },
                    {
                      trigger: "Twilio error rate > 3%",
                      action: "Switch telephony → Telnyx",
                    },
                    {
                      trigger: "Telnyx down > 60s",
                      action: "Switch telephony → Twilio",
                    },
                  ].map((rule, i) => (
                    <div
                      key={i}
                    ...
                    >
                      <div>
                        <p className="text-xs font-medium text-[#6b6b6b] uppercase tracking-wide mb-0.5">
                          Trigger
                        </p>
                        <p>{rule.trigger}</p>
                      </div>
