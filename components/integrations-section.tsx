...
const SlackLogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="Slack">
    ...
    <path
      d="M11 17.5a2.5 2.5 0 0 1-2.5-2.5 2.5 2.5 0 0 1 2.5-2.5h2.5V15a2.5 2.5 0 0 1-2.5 2.5Zm0 2a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z"
      fill="#E01E5A"
    />
    <path
      d="M17.5 11a2.5 2.5 0 0 1-2.5-2.5 2.5 2.5 0 0 1 2.5-2.5 2.5 2.5 0 0 1 2.5 2.5V11h-2.5Zm0 2a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z"
      fill="#36C5F0"
    />
    <path
      d="M21 17.5a2.5 2.5 0 0 1 2.5-2.5 2.5 2.5 0 0 1 2.5 2.5 2.5 2.5 0 0 1-2.5 2.5H21V17.5Zm-2 0a4.5 4.5 0 1 0 9 0 4.5 4.5 0 0 0-9 0Z"
      fill="#2EB67D"
    />
    <path
      d="M14.5 21a2.5 2.5 0 0 1 2.5 2.5 2.5 2.5 0 0 1-2.5 2.5 2.5 2.5 0 0 1-2.5-2.5V21h2.5Zm0-2a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9Z"
      fill="#ECB22E"
    />
  </svg>
);
...
const NotionLogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="Notion">
    ...
    />
    <path
      d="M8 8.5C8 7.67 8.67 7 9.5 7h10.89c.49 0 .96.19 1.31.54l3.11 3.11c.35.35.54.82.54 1.31V24c0 .83-.67 1.5-1.5 1.5H9.5C8.67 25.5 8 24.83 8 24V8.5Z"
      fill="#1a1a1a"
    />
    <path
      d="M11 12l2.5 3.5L16 12h2l-3.5 5 3.5 5h-2l-2.5-3.5L11 22H9l3.5-5L9 12h2Z"
      fill="white"
    />
  </svg>
);
...
const StripeLogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="Stripe">
    ...
    <path
      d="M15.5 12.4c0-.85.7-1.2 1.75-1.2 1.55 0 3.5.5 5 1.3V8.3C20.7 7.5 19.15 7 16.75 7c-4.3 0-7.25 2.2-7.25 5.85 0 5.7 7.85 4.8 7.85 7.25 0 1-.85 1.35-2 1.35-1.7 0-3.9-.7-5.65-1.65v4.25A14.1 14.1 0 0 0 15.25 25c4.4 0 7.45-2.1 7.45-5.85-.1-6.2-7.2-5.05-7.2-6.75Z"
      fill="white"
    />
  </svg>
);
...
const GitHubLogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="GitHub">
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M16 6a10 10 0 0 0-3.162 19.494c.5.092.682-.217.682-.482 0-.237-.009-.868-.013-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.154-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.646 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 16 9.82a9.58 9.58 0 0 1 2.504.337c1.909-1.294 2.747-1.025 2.747-1.025.546 1.376.202 2.394.1 2.646.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.579.688.481A10.001 10.001 0 0 0 16 6Z"
      fill="white"
    />
  </svg>
);
...
const HubSpotLogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="HubSpot">
    ...
    <path
      d="M19.5 15.5v2M15.5 12.5H8M16.5 18.5c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4 4 1.8 4 4Z"
      stroke="white"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
const SalesforceLogo = () => (
  ...
  >
    ...
    <path
      d="M13 10a4 4 0 0 1 3.5 2.07A3.5 3.5 0 0 1 22 15.5a3.5 3.5 0 0 1-3.5 3.5H11a3 3 0 1 1 2-5.2A4 4 0 0 1 13 10Z"
      fill="white"
    />
  </svg>
);
...
const OpenAILogo = () => (
  <svg viewBox="0 0 32 32" fill="none" className="w-7 h-7" aria-label="OpenAI">
    ...
    <path
      d="M24 16a8 8 0 1 1-16 0 8 8 0 0 1 16 0ZM16 11l1.5 4.5L22 17l-4.5 1.5L16 23l-1.5-4.5L10 17l4.5-1.5L16 11Z"
      fill="white"
      fillOpacity="0.85"
    />
  </svg>
...
const FEATURES = [
  {
    ...
    title: "Support SLA",
    description:
      "Guaranteed sub-hour response times with 24/7 priority support and a dedicated account manager for every enterprise customer.",
  },
  {
    Icon: Headphones,
    title: "Dedicated Deployment Support",
    description:
      "White-glove onboarding with dedicated engineers who help you integrate, configure, and scale your voice AI deployment from day one.",
  },
  {
    Icon: Server,
    title: "Scalable Infrastructure",
    description:
      "Auto-scaling architecture built for millions of concurrent calls, with 99.99% uptime SLAs and real-time failover across regions.",
  },
  {
    Icon: ShieldCheck,
    title: "SOC 2 Type II Certified",
    description:
      "End-to-end encryption, GDPR compliance, HIPAA-ready data handling, and annual third-party security audits included.",
  },
  {
    Icon: Globe,
    title: "Global Coverage",
    description:
      "Deploy voice agents in 40+ countries with regional routing, ultra-low-latency delivery, and local DID provisioning.",
  },
  {
    Icon: Lock,
    title: "Role-Based Access Control",
    description:
      "Fine-grained permissions, SSO/SAML, immutable audit logs, and custom data-retention policies — all configurable per workspace.",
  },
];
