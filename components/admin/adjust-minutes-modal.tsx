...
export function AdjustMinutesModal({
  workspaceId,
  currentUsed,
  currentLimit,
  userName,
  ...
  async function save() {
    ...
    const res = await fetch("/api/admin/adjust-minutes", {
      ...
      body: JSON.stringify({
        ...
        minutes_used:
          minutesUsed !== String(currentUsed) ? Number(minutesUsed) : undefined,
        minutes_limit:
          minutesLimit !== String(currentLimit)
            ? Number(minutesLimit)
            : undefined,
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Override usage or limit. All changes are logged in
              workspace_events.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                min="0"
                value={minutesUsed}
                onChange={(e) => setMinutesUsed(e.target.value)}
              />
            ...
            <div className="space-y-1.5">
              <Label>
                Add bonus minutes (reduces minutes_used by this amount)
              </Label>
              <Input
                type="number"
                min="0"
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. Customer complaint, compensation"
              />
            </div>
          </div>
          <DialogFooter>
