  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-white text-[#0a0a0a] border border-[#e0e0e0] hover:bg-[#f5f5f5]",
        outline:
          "border border-[#e0e0e0] bg-transparent text-[#0a0a0a] hover:bg-[#f5f5f5]",
        ghost: "text-[#0a0a0a] hover:bg-[#f5f5f5]",
        destructive: "bg-[#0a0a0a] text-white hover:bg-[#262626]",
