...
function MorphingObject({ speed = 0.4 }: MorphingObjectProps) {
  ...
  const seedGeo = useMemo(() => {
    ...
    g.setAttribute(
      "position",
      new THREE.BufferAttribute(new Float32Array(targetLen), 3),
    );
    g.setAttribute(
      "normal",
      new THREE.BufferAttribute(new Float32Array(targetLen), 3),
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:flex-1">
            ...
            <p className="mt-6 max-w-md text-base leading-relaxed text-violet-200/70 lg:text-lg">
              Despliega agentes de voz inteligentes en segundos. Conecta con tus
              clientes por teléfono con IA que entiende, responde y actúa en
              tiempo real.
            </p>

            {/* CTAs */}
            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button className="group relative overflow-hidden rounded-xl bg-violet-600 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-violet-900/50 transition-all duration-200 hover:bg-violet-500 hover:shadow-violet-700/50 hover:-translate-y-0.5 active:scale-[0.98]">
            ...
            <div className="mt-10 flex items-center gap-4">
              <div className="flex -space-x-2">
                {["A", "B", "C", "D"].map((l, i) => (
                  <div
                    ...
                    style={{
                      background: ["#7c3aed", "#6d28d9", "#5b21b6", "#4c1d95"][
                        i
                      ],
                    }}
                  >
              ...
              <p className="text-xs text-violet-300/70">
                <span className="font-semibold text-violet-200">+2 400</span>{" "}
                empresas confían en VoiceOS
              </p>
            </div>
          </div>
          ...
          <div className="relative w-full max-w-sm lg:max-w-none lg:flex-1 lg:max-w-[520px]">
            ...
            <div className="relative mx-auto w-full max-w-[480px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse, #7c3aed55 0%, transparent 70%)",
                }}
              />
            </div>
