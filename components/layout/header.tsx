...
export function Header({
  ...
  return (
    <header
      className="fixed left-56 right-0 top-0 z-30 flex h-14 items-center justify-between glass border-b border-[#e8e8e8]/60 px-6"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-2">
        {/* Plan badge */}
        <Badge
          className={`${plan.className} text-[10px] px-2 py-0.5 font-semibold tracking-wider`}
        >
        ...
        <Link href="/notifications" className="relative">
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 rounded-xl hover:bg-[#f5f5f5]"
          >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-52 rounded-xl border border-[#e8e8e8] shadow-xl"
          >
            ...
            <DropdownMenuItem asChild>
              <Link
                href="/settings"
                className="flex items-center gap-2 cursor-pointer rounded-lg text-[12.5px]"
              >
