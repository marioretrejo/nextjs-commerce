...
export function MinutePill({
  ...
  return (
    <Link href="/analytics/costs">
      <span
        className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium transition-colors ${pillClass}`}
      >
        {remaining >= 10
          ? remaining.toFixed(0)
          : remaining >= 1
