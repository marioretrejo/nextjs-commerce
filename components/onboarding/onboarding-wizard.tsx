...
const USE_CASES = [
  {
    ...
    description:
      "Prospect leads, qualify interest, and book demos automatically.",
    color: "blue",
...
- Keep calls under 5 minutes unless the prospect wants to continue.`,
    firstMessage:
      "Hi, this is {agent_name} calling from {company_name}. I hope I'm not catching you at a bad time — do you have just two minutes?",
  },
  {
    id: "support",
    icon: Headphones,
    ...
    description:
      "Handle inbound queries, resolve issues, and escalate when needed.",
    color: "green",
...
- Always confirm the customer's name and issue before diving into solutions.`,
    firstMessage:
      "Thank you for calling support. My name is {agent_name} — I'm here to help. Could I get your name and a brief description of the issue?",
  },
  {
    id: "medical",
    icon: Stethoscope,
    ...
    description:
      "Book appointments, handle intake, and answer clinic questions.",
    color: "purple",
...
- Confirm all appointment details (date, time, doctor, location) before ending the call.`,
    firstMessage:
      "Good day, thank you for calling. This is {agent_name} at the clinic. How can I assist you today?",
  },
];
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden">
          ...
          <div className="bg-[#0a0a0a] px-8 py-6 text-white">
            ...
            <h1 className="text-xl font-bold">
              {step === 1 &&
                `Welcome, ${firstName}! What will you use VoiceOS for?`}
              {step === 2 && `Your agent is ready 🎉`}
              {step === 3 && `You're all set!`}
            </h1>
            <p className="text-sm text-white/60 mt-1">
              {step === 1 &&
                "We'll configure your first AI agent automatically based on your use case."}
              {step === 2 &&
                "Add credit to activate your agent and start making calls."}
              ...
              <div className="space-y-3">
                {USE_CASES.map((uc) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Icon
                          className={`h-5 w-5 ${isSelected ? colors.text : "text-[#6b6b6b]"}`}
                        />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p
                          className={`font-semibold text-sm ${isSelected ? colors.text : "text-[#0a0a0a]"}`}
                        >
                          {uc.label}
                        </p>
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <Bot className="h-4 w-4 mr-2" /> Create My{" "}
                      {selectedUC?.label ?? ""} Agent{" "}
                ...
                <div className="flex items-center gap-3 rounded-xl bg-[#f5f5f5] p-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#6b6b6b]">
                      Pre-configured with a professional{" "}
                      {selectedUC?.label.toLowerCase()} prompt
                    </p>
                  </div>
                ...
                <div className="rounded-xl border-2 border-dashed border-[#e0e0e0] p-5 text-center space-y-3">
                  ...
                  <div>
                    <p className="font-semibold text-[#0a0a0a]">
                      Activate with a small credit top-up
                    </p>
                    <p className="text-sm text-[#6b6b6b] mt-1">
                      Your agent is built. Add at least $10 in credit to unlock
                      calling, analytics, and all features. You only pay for
                      what you use — credit never expires.
                    </p>
                  </div>
                  <Button
                    className="w-full"
            ...
            {step === 3 && (
              <div className="text-center space-y-4 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#6b6b6b] mt-1">
                    Your workspace is ready. Explore your dashboard and start
                    building.
                  </p>
                </div>
                <Button
