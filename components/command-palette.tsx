...
export function CommandPalette() {
  ...
  const commands: CommandAction[] = [
    ...
    },
    {
      ...
      icon: DollarSign,
      action: () => navigate("/analytics/costs"),
      group: "Navigate",
    },
    {
      id: "nav-quality",
    ...
    // Quick actions
    {
      ...
      description: "Open agent creation wizard",
      icon: Bot,
    ...
    },
    {
      ...
      description: "Launch campaign wizard",
      icon: Megaphone,
    ...
    },
    {
      ...
      description: "Create a programmatic access key",
      icon: Key,
      action: () => navigate("/settings/api-keys"),
      group: "Quick Actions",
    },
    {
      ...
      description: "Watch calls in real time",
      icon: Radio,
      action: () => navigate("/calls/live"),
      group: "Quick Actions",
    },
    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      <Command className="rounded-xl border border-[#e0e0e0] shadow-2xl overflow-hidden bg-white">
        ...
        <CommandList className="max-h-80 overflow-y-auto p-2">
          ...
          {groups.map((group, gi) => (
            ...
            >
              ...
              {gi < groups.length - 1 && (
                <CommandSeparator className="my-1 h-px bg-[#f5f5f5]" />
              )}
            </CommandGroup>
          ))}
        </CommandList>
        <div className="border-t border-[#e0e0e0] px-4 py-2 flex items-center gap-4 text-xs text-[#6b6b6b]">
          <span>
            <kbd className="font-mono bg-[#f5f5f5] px-1.5 py-0.5 rounded text-xs">
              ↑↓
            </kbd>{" "}
            navigate
          </span>
...
export function CommandPaletteTrigger() {
  ...
  return (
    ...
    >
      ...
      <span>Search</span>
      <kbd className="ml-1 font-mono text-xs bg-[#f5f5f5] px-1.5 py-0.5 rounded">
        ⌘K
      </kbd>
    </button>
  );
