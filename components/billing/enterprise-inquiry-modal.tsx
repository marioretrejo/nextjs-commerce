      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Tell us about your needs and our team will craft a custom plan for
              you.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label>
                Monthly call volume <span className="text-[#0a0a0a]">*</span>
              </Label>
            ...
            <div className="space-y-1.5">
              <Label>
                Countries / regions{" "}
                <span className="text-xs text-[#6b6b6b]">(optional)</span>
              </Label>
              <Input
                value={countries}
          ...
          <DialogFooter>
            ...
            <Button
              onClick={submit}
              disabled={sending || !company.trim() || !volume}
            >
